                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('labels.edit_faq') }}</h3>
                            </div>
                        </div>
                    </div>

                    <div class="card-body">
                        <form method="post" action="{{ route('faqs.update', $faq->id) }}" id="my-form" autocomplete="off">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="question" id="input-question" class="form-control {{ $errors->has('question') ? ' is-invalid' : '' }}" placeholder="{{ __('labels.question') }}" value="{{ old('question', $faq->question) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('answer') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="answer" id="input-answer" rows="6" class="form-control {{ $errors->has('answer', $faq->answer) ? ' is-invalid' : '' }}" placeholder="{{ __('labels.answer') }}" required>{{ old('answer', $faq->answer) }}</textarea>
