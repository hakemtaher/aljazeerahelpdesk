...
function initMap() {
    ...
    var contentString = '<div class="info-window-content"><h2>UltimateDesk Dashboard</h2>' +
        '<p>A beautiful and reliable support system.</p></div>';
...
function initMap() {
    ...
    var contentString = '<div class="info-window-content"><h2>UltimateDesk Dashboard PRO</h2>' +
        '<p>A reliable platform.</p></div>';
